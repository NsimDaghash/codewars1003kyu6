...
You have a string. The string consists of words. Before words can be an exclamation mark !. Also some words are marked as one set with square brackets []. 
...
function cleverSplit(s) {
  // Regular expression to match words, sets within square brackets, and exclamation marks
  const regex = /(\[.*?\]|\S+|!)/g;
